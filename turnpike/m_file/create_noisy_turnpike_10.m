...
dist_min = 1e-2;
dist_unit = 1e-3;   % the quantization step size, should be smaller than dist_min
n_std = [0 1e-3 3e-3 5e-3 7e-3 9e-3]; % the noise standard deviations under differnt noise levels
